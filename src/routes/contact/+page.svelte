...
<div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
  <h3 class="mb-4 text-4xl tracking-tight font-extrabold">Contact</h3>
  <p class="mb-8 lg:mb-16">Got a question? Do you want to know more about us? Send us a message?</p>
  <form action="#" class="space-y-8">
    ...
    >
    <button class="btn btn-primary py-3" on:click={contactMe}>Send</button>
  </form>
</div>
